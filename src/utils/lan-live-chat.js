...
var makeBrotliDecode = function makeBrotliDecode() {
  ...
  function calculateDistanceAlphabetLimit(maxDistance, npostfix, ndirect) {
    ...
    var /** @type {number} */ offset =
        ((maxDistance - ndirect) >> npostfix) + 4;
    var /** @type {number} */ ndistbits = log2floor(offset) - 1;
    var /** @type {number} */ group =
  ...
  function unpackCommandLookupTable(cmdLookup) {
    ...
    for (var /** @type {number} */ cmdCode = 0; cmdCode < 704; ++cmdCode) {
      ...
      var /** @type {number} */ insertCode =
          (((0x29850 >>> (rangeIdx * 2)) & 0x3) << 3) | ((cmdCode >>> 3) & 7);
      var /** @type {number} */ copyCode =
  ...
  function initState(s, input) {
    ...
    s.blockTrees[0] = 7;
    s.distRbIdx = 3;
    var /** @type {number} */ maxDistanceAlphabetLimit =
        calculateDistanceAlphabetLimit(0x7ffffffc, 3, 120);
  ...
  function decodeMetaBlockLength(s) {
    ...
    if (sizeNibbles === 7) {
      ...
      for (var /** @type {number} */ _i = 0; _i < sizeNibbles; _i++) {
        if (s.bitOffset >= 16) {
          s.accumulator32 =
            (s.shortBuffer[s.halfOffset++] << 16) | (s.accumulator32 >>> 16);
          s.bitOffset -= 16;
        }
        var /** @type {number} */ _bits = readFewBits(s, 4);
  ...
  function inverseMoveToFrontTransform(v, vLen) {
    ...
    for (var /** @type {number} */ _i2 = 0; _i2 < vLen; _i2++) {
      var /** @type {number} */ index = v[_i2] & 0xff;
      v[_i2] = mtf[index];
      if (index !== 0) {
  ...
  function readHuffmanCodeLengths(
    ...
    var /** @type {!Int32Array} */ table = new Int32Array(33);
  ...
  function readSimpleHuffmanCode(
    ...
    var /** @type {!Int32Array} */ codeLengths = new Int32Array(
        alphabetSizeLimit
      );
  ...
  function decodeBlockTypeAndLength(s, treeType, numBlockTypes) {
    ...
    var /** @type {number} */ blockType = readSymbol(
        s.blockTrees,
        2 * treeType,
        s
      );
    var /** @type {number} */ result = readBlockLength(
        s.blockTrees,
        2 * treeType + 1,
        s
      );
  ...
  function maybeReallocateRingBuffer(s) {
    ...
    var /** @type {!Int8Array} */ newBuffer = new Int8Array(
  ...
  function calculateDistanceLut(s, alphabetSizeLimit) {
    ...
    while (i < alphabetSizeLimit) {
      var /** @type {number} */ base =
          ndirect + ((((2 + half) << bits) - 4) << npostfix) + 1;
      for (var /** @type {number} */ _j = 0; _j < postfix; ++_j) {
  ...
  function readMetablockHuffmanCodesAndContextMaps(s) {
    ...
    for (var /** @type {number} */ i = 0; i < s.numLiteralBlockTypes; ) {
      var /** @type {number} */ limit = Math.min(
          i + 96,
          s.numLiteralBlockTypes
        );
      for (; i < limit; ++i) {
    ...
    var /** @type {number} */ numLiteralTrees = decodeContextMap(
    ...
    var /** @type {number} */ numDistTrees = decodeContextMap(
    ...
    var /** @type {number} */ distanceAlphabetSizeLimit =
  ...
  function copyUncompressedData(s) {
    ...
    var /** @type {number} */ chunkLength = Math.min(
  ...
  function writeRingBuffer(s) {
    var /** @type {number} */ toWrite = Math.min(
  ...
  function doUseDictionary(s, fence) {
    ...
    if (address < 0) {
      ...
      var /** @type {number} */ len = transformDictionaryWord(
          s.ringBuffer,
          s.pos,
          dictionaryData,
          offset,
    ...
    while (s.runningState !== 10) {
      switch (s.runningState) {
        ...
        case 4:
          ...
          var /** @type {number} */ cmdCode =
              readSymbol(s.commandTreeGroup, s.commandTreeIdx, s) << 2;
          var /** @type {number} */ insertAndCopyExtraBits =
              CMD_LOOKUP[cmdCode];
          var /** @type {number} */ insertLengthOffset =
          ...
          var /** @type {number} */ insertLengthExtraBits =
          ...
          var /** @type {number} */ copyLengthExtraBits =
        ...
        case 7:
          if (s.trivialLiteralContext !== 0) {
            ...
            var /** @type {number} */ prevByte1 =
                ringBuffer[(s.pos - 1) & ringBufferMask] & 0xff;
            var /** @type {number} */ prevByte2 =
            ...
            while (s.j < s.insertLength) {
              ...
              var /** @type {number} */ literalContext =
          ...
          if (distanceCode < 0) {
            ...
            if (distanceCode < 16) {
              ...
              var /** @type {number} */ extraBits =
                  s.distExtraBits[distanceCode];
              var /** @type {number} */ bits = void 0;
  ...
  function unpackTransforms(
    ...
    for (var /** @type {number} */ _i3 = 0; _i3 < 363; ++_i3) {
  ...
  function transformDictionaryWord(
    ...
    var /** @type {!Int8Array} */ prefixSuffixStorage =
        transforms.prefixSuffixStorage;
    var /** @type {!Int32Array} */ prefixSuffixHeads =
    ...
    var /** @type {number} */ omitLast = transformType;
    ...
    if (transformType === 10 || transformType === 11) {
      ...
      var /** @type {number} */ scalar =
          (param & 0x7fff) + (0x1000000 - (param & 0x8000));
      while (len > 0) {
        var /** @type {number} */ step = 1;
        var /** @type {number} */ _c = dst[shiftOffset] & 0xff;
        if (_c < 0x80) {
          scalar += _c;
          ...
          if (len >= 3) {
            var /** @type {number} */ _c2 = dst[shiftOffset + 1];
          ...
          if (len >= 4) {
            var /** @type {number} */ _c3 = dst[shiftOffset + 1];
            var /** @type {number} */ _c4 = dst[shiftOffset + 2];
  ...
  function buildHuffmanTable(
    ...
    symbol = 0;
    for (
      var /** @type {number} */ _len = 1, /** @type {number} */ step = 2;
      _len <= rootBits;
      _len++, step <<= 1
    ) {
    ...
    for (
      var /** @type {number} */ _len2 = rootBits + 1,
        /** @type {number} */ _step = 2;
      _len2 <= 15;
      _len2++, _step <<= 1
    ) {
      for (; count[_len2] > 0; count[_len2]--) {
        ...
        replicateValue(
          ...
          _step,
          tableSize,
          ((_len2 - rootBits) << 16) | sorted[symbol++]
        );
  ...
  function copyRawBytes(s, data, offset, length) {
    ...
    var /** @type {number} */ copyNibbles = Math.min(
        halfAvailable(s),
        length >> 1
      );
    if (copyNibbles > 0) {
  ...
  function unpackLookupTable(lookup, map, rle) {
    ...
    for (var /** @type {number} */ _i4 = 0; _i4 < 128; ++_i4) {
      lookup[1024 + _i4] = 4 * (map.charCodeAt(_i4) - 32);
    }
    for (var /** @type {number} */ _i5 = 0; _i5 < 64; ++_i5) {
    ...
    for (var /** @type {number} */ k = 0; k < 19; ++k) {
      ...
      for (var /** @type {number} */ _i6 = 0; _i6 < rep; ++_i6) {
        lookup[offset++] = value;
      }
    }
    for (var /** @type {number} */ _i7 = 0; _i7 < 16; ++_i7) {
      lookup[1792 + _i7] = 1;
      lookup[2032 + _i7] = 6;
    }
    lookup[1792] = 0;
    lookup[2047] = 7;
    for (var /** @type {number} */ _i8 = 0; _i8 < 256; ++_i8) {
  ...
  function setData(newData, newSizeBits) {
    ...
    for (var /** @type {number} */ _i9 = 0; _i9 < newSizeBits.length; ++_i9) {
      dictionaryOffsets[_i9] = pos;
      var /** @type {number} */ bits = dictionarySizeBits[_i9];
      if (bits !== 0) {
        if (bits >= 31) {
    ...
    for (
      var /** @type {number} */ _i10 = newSizeBits.length;
      _i10 < 32;
      ++_i10
    ) {
  ...
  function unpackDictionaryData(
    ...
    for (var /** @type {number} */ i = 0; i < n; i += 2) {
      ...
      for (var /** @type {number} */ j = 0; j < skip; ++j) {
        dict[offset] ^= 3;
        offset++;
      }
      for (var /** @type {number} */ _j2 = 0; _j2 < flip; ++_j2) {
        dict[offset] ^= 236;
        offset++;
      }
    }
    for (
      var /** @type {number} */ _i11 = 0;
      _i11 < sizeBitsData.length;
      ++_i11
    ) {
  ...
  {
    var /** @type {!ByteBuffer} */ dictionaryData = new Int8Array(122784);
  ...
  function readInput(src, dst, offset, length) {
    ...
    var /** @type {number} */ end = Math.min(
        src.offset + length,
        src.data.length
      );
    var /** @type {number} */ bytesRead = end - src.offset;
  ...
  function toUsAsciiBytes(src) {
    var /** @type {number} */ n = src.length;
    var /** @type {!Int8Array} */ result = new Int8Array(n);
    for (var /** @type {number} */ i = 0; i < n; ++i) {
  ...
  function decode(bytes, options) {
    ...
    var /** @type {number} */ totalOutput = 0;
    var /** @type {!Array<!Int8Array>} */ chunks = [];
    while (true) {
      var /** @type {!Int8Array} */ chunk = new Int8Array(16384);
      chunks.push(chunk);
      s.output = chunk;
      s.outputOffset = 0;
    ...
    close(s);
    var /** @type {!Int8Array} */ result = new Int8Array(totalOutput);
    var /** @type {number} */ offset = 0;
    for (var /** @type {number} */ i = 0; i < chunks.length; ++i) {
      var /** @type {!Int8Array} */ _chunk = chunks[i];
      var /** @type {number} */ end = Math.min(totalOutput, offset + 16384);
      var /** @type {number} */ len = end - offset;
      if (len < 16384) {
 ...
 *
 */
var BClient = /** @class */ (function () {
  function BClient(room_id, url) {
    if (url === void 0) {
      url = "wss://broadcastlv.chat.bilibili.com:443/sub";
    }
    if (typeof window === "undefined") {
      console.log("请运行于浏览器环境");
    } else {
  ...
  // 连接
  BClient.prototype.connect = function () {
    this.ws = new WebSocket(this.url);
  };
  // 连接成功时
  BClient.prototype.onOpen = function () {
    var _this = this;
    console.log("open");
    // 发送认证信息
    var certification = {
    ...
    this.ws.send(getCertification(JSON.stringify(certification)));
    // 每10秒轮询发送心跳包
    this.timer = setInterval(function () {
      var buff = new ArrayBuffer(16);
      var i = new DataView(buff);
      i.setUint32(0, 0);
      i.setUint16(4, 16);
      i.setUint16(6, 1);
      i.setUint32(8, 2);
  ...
  BClient.prototype.onMessage = function (e) {
    var blob = e.data;
    handleMessage(blob, function (result) {
      ...
      for (var i = 0; i < result.length; i++) {
        ...
        if (json.Type == 5) {
          var event_1 = new CustomEvent(JSON.parse(json.body).cmd, {
            detail: JSON.parse(json.body),
          });
          eventTarget.dispatchEvent(event_1);
        }
        if (json.Type == 8) {
          var event_2 = new CustomEvent("Certify_Success", {
            detail: JSON.parse(json.body),
          });
          eventTarget.dispatchEvent(event_2);
        }
        if (json.Type == 3) {
          var event_3 = new CustomEvent("VIEW", { detail: json.body });
          eventTarget.dispatchEvent(event_3);
        }
      }
    });
  };
  BClient.prototype.onClose = function () {
    var _this = this;
    //当客户端收到服务端发送的关闭连接请求时，触发onclose事件
    console.log("close");
    if (this.timer != null) {
      clearInterval(this.timer); //停止发送心跳包
    }
    setTimeout(function () {
      _this.connect();
    }, 10000);
  };
  BClient.prototype.onError = function (e) {
...
function getCertification(json) {
  var encoder = new TextEncoder(); //编码器
  var jsonView = encoder.encode(json); //utf-8编码
  var buff = new ArrayBuffer(jsonView.byteLength + 16); //数据包总长度：16位头部长度+bytes长度
  var view = new DataView(buff); //新建操作视窗
  ...
  for (var r = 0; r < jsonView.byteLength; r++) {
...
function handleMessage(blob, call) {
  ...
  reader.onload = function (e) {
    var buff = e.target.result; //ArrayBuffer对象
    var decoder = new TextDecoder(); //解码器
    var view = new DataView(buff); //视图
    var offset = 0;
    var packet = {};
    var result = [];
    while (offset < buff.byteLength) {
      //数据提取
      var packetLen = view.getUint32(offset + 0);
      var headLen = view.getUint16(offset + 4);
      var packetVer = view.getUint16(offset + 6);
      var packetType = view.getUint32(offset + 8);
      var num = view.getUint32(12);
      // 数据包协议版本为3时封包为数据包
      if (packetVer == 3) {
        //解压数据
        var brArray = new Uint8Array(
          buff,
          offset + headLen,
          packetLen - headLen
        );
        var BrotliDecode = makeBrotliDecode(); //生成Brotli格式解压工具的实例
        var buffFromBr = BrotliDecode(brArray); //返回Int8Array视图
        var view_1 = new DataView(buffFromBr.buffer);
        var offset_Ver3 = 0;
        while (offset_Ver3 < buffFromBr.byteLength) {
          //解压后数据提取
          var packetLen_1 = view_1.getUint32(offset_Ver3 + 0);
          var headLen_1 = view_1.getUint16(offset_Ver3 + 4);
          var packetVer_1 = view_1.getUint16(offset_Ver3 + 6);
          var packetType_1 = view_1.getUint32(offset_Ver3 + 8);
          var num_1 = view_1.getUint32(12);
          packet.Len = packetLen_1;
          packet.HeadLen = headLen_1;
          packet.Ver = packetVer_1;
          packet.Type = packetType_1;
          packet.Num = num_1;
          var dataArray = new Uint8Array(
            buffFromBr.buffer,
            offset_Ver3 + headLen_1,
            packetLen_1 - headLen_1
          );
          packet.body = decoder.decode(dataArray); //utf-8格式数据解码，获得字符串
          result.push(JSON.stringify(packet)); //数据打包后传入数组
          offset_Ver3 += packetLen_1;
        }
      } else {
 ...
 * @param callback
 */
function Bon(eventType, callback) {
